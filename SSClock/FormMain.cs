namespace SSClock {
    ...
    public partial class FormMain : Form {
        ...
        #region Draw
        private const Int32 SZ_TIME = 120;
        private const Int32 SZ_DATE = 32;
        ...
        private Double x = 0D;
        private Double y = 0D;
        private const Int32 LINE_SPACE = 0;
        ...
        private void draw() {
            ...
            path.AddString(strTime, this.fontFamily, (Int32)FontStyle.Regular, SZ_TIME,
                                 new Point((Int32)this.x, (Int32)this.y), drawFormat);
            path.AddString(strDate, this.fontFamily, (Int32)FontStyle.Regular, SZ_DATE,
                                 new Point((Int32)this.x, (Int32)(this.y + (szStrTime.Height / 2) + LINE_SPACE)), drawFormat);
